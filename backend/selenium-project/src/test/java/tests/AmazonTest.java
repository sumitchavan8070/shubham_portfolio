...
public class AmazonTest {
    ...
    // waitUtils.waitForElementToBeClickable(By.id("twotabsearchtextbox"), 15);
    // searchBox.clear();
    ...
    // waitUtils.waitForElementPresence(By.cssSelector("[data-component-type='s-search-result']"),
    // 20);

    // // Verify search results are displayed
    // String currentUrl = driver.getCurrentUrl();
    // Assert.assertTrue(currentUrl.contains("laptop"), "Search results verification
    // failed");
    ...
    // Assert.assertTrue(productTitle.isDisplayed(), "Product page verification
    // failed");
